...
public class ItemRegistry {
    ...
    public static final RegistryObject<BlockItem> RAIL_GUN_1MEDIUM_ITEM = ITEMS.register(new RailGun1Medium().getRegisterName(ITEM),() -> new BlockItem(BlockRegistry.RAIL_GUN_1_MEDIUM_BLOCK.get(), new Item.Properties().tab(Stardust.stardustCreativeGroup)));
